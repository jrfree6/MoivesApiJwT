...
public class JwtTokenUtil implements Serializable {
	...
	private String doGenerationToken(Map<String, Object> claims, String username) {
		return Jwts.builder()
					.setClaims(claims)
					.setSubject(username)
					.setIssuedAt(new java.util.Date(System.currentTimeMillis()))
					.setExpiration(new java.util.Date(System.currentTimeMillis() + JWT_TOKEN_VALIDATY * 1000))
